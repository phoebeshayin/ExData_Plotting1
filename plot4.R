setwd("~/Documents/Coursera/4- Exploratory Data Analysis/Course Project 1/ExData_Plotting1")
...
## Transform Data and Time vars from characters into objects of type Date and POSIXlt 
